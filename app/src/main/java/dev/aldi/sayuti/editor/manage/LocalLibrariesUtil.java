...
import static laki.webide.utility.FileUtil.deleteFile;
import static laki.webide.utility.FileUtil.getExternalStorageDir;
import static laki.webide.utility.FileUtil.isExistFile;
import static laki.webide.utility.FileUtil.listDirAsFile;
import static laki.webide.utility.FileUtil.readFile;
import static laki.webide.utility.FileUtil.writeFile;
...
public class LocalLibrariesUtil {
    private static final String localLibsPath = getExternalStorageDir().concat("/.lakiwebsites/libs/local_libs/");
    ...
    public static File getLocalLibFile(String scId) {
        return new File(getExternalStorageDir().concat("/.lakiwebsites/data/").concat(scId.concat("/local_library")));
    }
