...
import laki.webide.xml.XmlBuilderHelper;
...
public class ProjectWorkspace {
    ...
    /**
     * Example content: /storage/emulated/0/.lakiwebsites/mysc/605/app/src/main/assets
     */
    public final String assetsPath;

    /**
     * Example content: /storage/emulated/0/.lakiwebsites/mysc/605/app/src/main/assets/fonts
     */
    public final String fontsPath;

    /**
     * Path of ZIP file containing compiled resources of the current project,
     * e.g. /storage/emulated/0/.lakiwebsites/mysc/605/bin/InternalDemo.apk.res
     */
    public final String resourcesApkPath;

    /**
     * Example content: /storage/emulated/0/.lakiwebsites/mysc/605/bin/classes.dex
     */
    public final String classesDexPath;

    /**
     * Example content: /storage/emulated/0/.lakiwebsites/mysc/605/bin/InternalDemo.apk.unsigned
     */
    public final String unsignedUnalignedApkPath;

    /**
     * Example content: /storage/emulated/0/.lakiwebsites/mysc/605/bin/InternalDemo.apk
     */
    public final String finalToInstallApkPath;

    /**
     * Example content: /storage/emulated/0/lakiwebsites/signed_apk/InternalDemo_release.apk
     */
    public final String releaseApkPath;
    /**
     * Example content: /storage/emulated/0/.lakiwebsites/mysc/605/bin/InternalDemo.apk.unsigned.aligned
     */
    public final String unsignedAlignedApkPath;
    public final boolean isSimpleProject;
    public final String sc_id;
    /**
     * Example content: /storage/emulated/0/.lakiwebsites/mysc/605/
     */
     ...
     * e.g. /storage/emulated/0/.lakiwebsites/mysc/605/bin/aapt_rules.pro
     */
    ...
    /**
     * Example content: /storage/emulated/0/.lakiwebsites/mysc/605/app/src/main/AndroidManifest.xml
     */
    public final String androidManifestPath;
    /**
     * Example content: /storage/emulated/0/.lakiwebsites/mysc/605/app/src/main
     */
    public final String generatedFilesPath;
    /**
     * Example content: /storage/emulated/0/.lakiwebsites/mysc/605/bin
     */
    public final String binDirectoryPath;
    /**
     * Example content: /storage/emulated/0/.lakiwebsites/mysc/605/bin/classes
     */
    public final String compiledClassesPath;
    /**
     * Project's generated R.java files directory,
     * e.g. /storage/emulated/0/.lakiwebsites/mysc/605/gen
     */
    public final String rJavaDirectoryPath;
    /**
     * Example content: /storage/emulated/0/.lakiwebsites/mysc/605/app/src/main/res
     */
    public final String resDirectoryPath;
    /**
     * Example content: /storage/emulated/0/.lakiwebsites/mysc/605/app/src/main/proguard-rules.pro
     */
    public final String proguardFilePath;
    /**
     * Example content: /storage/emulated/0/.lakiwebsites/mysc/605/app/src/main/res/layout
     */
    public final String layoutFilesPath;
    /**
     * Example content: /storage/emulated/0/.lakiwebsites/mysc/605/app/src/main/java
     */
    public final String javaFilesPath;
    /**
     * Example content: /storage/emulated/0/.lakiwebsites/mysc/605/app/src/main/res/raw
     */
    ...
    public ProjectWorkspace(Context context, String myscFolderPath, HashMap<String, Object> metadata) {
        ...
        isSimpleProject = true; // Forced true for Website support
        ...
        versionCode = "1.0.0"; // Static for web
        versionName = "1.0.0";
        ...
        resDirectoryPath = projectMyscPath + "res"; 
        androidManifestPath = "";
        layoutFilesPath = "";
        javaFilesPath = "";
        resourcesApkPath = "";
        classesDexPath = "";
        unsignedUnalignedApkPath = "";
        unsignedAlignedApkPath = "";
        finalToInstallApkPath = "";
        releaseApkPath = "";
        proguardClassesPath = "";
        proguardAaptRules = "";
        proguardSeedsPath = "";
        proguardUsagePath = "";
        proguardMappingPath = "";
        proguardAutoGeneratedExclusions = "";
        rJavaDirectoryPath = "";
        generatedFilesPath = "";
        proguardFilePath = "";
        importedSoundsPath = "";
    ...
    /**
     * Deletes the directory {@link ProjectWorkspace#resDirectoryPath}/values-v21/.
     */
    public void a() {
    ...
    /**
     * Creates needed build directories {@link ProjectWorkspace#binDirectoryPath}, {@link ProjectWorkspace#compiledClassesPath}, {@link ProjectWorkspace#rJavaDirectoryPath}, {@link ProjectWorkspace#javaFilesPath}, {@link ProjectWorkspace#resDirectoryPath},
     * {@link ProjectWorkspace#layoutFilesPath}, {@link ProjectWorkspace#importedSoundsPath}, {@link ProjectWorkspace#assetsPath}, and {@link ProjectWorkspace#fontsPath}.
     */
    ...
    /**
     * Prepares to compile and creates /Internal storage/.lakiwebsites/mysc/&lt;sc_id&gt;/ directories,
     * {@link ProjectWorkspace#binDirectoryPath}, {@link ProjectWorkspace#compiledClassesPath} and {@link ProjectWorkspace#rJavaDirectoryPath}.
     */
    public void e() {
        fileUtil.f(binDirectoryPath);
        fileUtil.f(compiledClassesPath);
    ...
    /**
     * Deletes temporary compile cache directories, {@link ProjectWorkspace#binDirectoryPath} and {@link ProjectWorkspace#rJavaDirectoryPath}. The used method
    ...
    /**
     * Extracts a ZIP archive from assets to {@link ProjectWorkspace#resDirectoryPath}.
     */
    ...
    /**
     * Copies a file to the project's app icon path, {@link ProjectWorkspace#resDirectoryPath}/drawable-xhdpi/app_icon.png
     */
    ...
    /**
     * Copies a mipMaps folder to the project's app icon path, {@link ProjectWorkspace#resDirectoryPath}/mipmap
     */
    ...
    /**
     * Creates ic_launcher.xml to the project's app icon path, {@link ProjectWorkspace#resDirectoryPath}/mipmap-anydpi-v26
     */
    ...
    public void generateDebugFiles(Context context) {
        ...
        String javaDir = FileUtil.getExternalStorageDir() + "/.lakiwebsites/data/" + sc_id + "/files/java/";
        ...
        if (!customApplicationClassName.startsWith(".")) {
            customApplicationClassName = "." + customApplicationClassName; // since lakiwebsites don't allow creating any java file outside the package name
        }
     ...
     * <pre>
     *     {@link ProjectWorkspace#javaFilesPath} + File.separator + {@link ProjectWorkspace#packageNameAsFolders}
     * </pre>, while AndroidManifest.xml gets saved to {@link ProjectWorkspace#androidManifestPath}.
     */
    ...
    public ArrayList<SrcCodeBean> a(hC projectFileManager, eC projectDataManager, BuiltInLibraryManager builtInLibraryManager) {
        ...
        String javaDir = FileUtil.getExternalStorageDir() + "/.lakiwebsites/data/" + sc_id + "/files/java/";
        String layoutDir = FileUtil.getExternalStorageDir() + "/.lakiwebsites/data/" + sc_id + "/files/resource/layout/";
        List<File> javaFiles;
        {
        ...
        // at /Internal storage/.lakiwebsites/data/<sc_id>/files/java/
        ...
        if (newXMLCommand && FileUtil.isExistFile(path)) {
            FileUtil.copyFile(path, FileUtil.getExternalStorageDir().concat("/.lakiwebsites/temp/commands"));
        }
        ...
        // at /Internal storage/.lakiwebsites/data/<sc_id>/files/resource/layout/
        ...
        for (ProjectFileBean layout : regularLayouts) {
            ...
            if (isSimpleProject) {
                ...
                for (ProjectFileBean bean : regularLayouts) {
                    if (xmlName.equalsIgnoreCase(bean.getXmlName())) {
                        fileBean = bean;
                        break;
                    }
                }
                String headCode = laki.webide.managers.HeadEditorManager.getGeneratedHtml(sc_id, (fileBean != null ? fileBean : new ProjectFileBean(0, xmlName)));
                HtmlGenerator htmlGen = new HtmlGenerator(xmlName, eC.a(projectDataManager.d(xmlName)), headCode);
                outputCode = htmlGen.generate();
            } else {
                Ox xmlLayoutGenerator = new Ox(N, layout);
                xmlLayoutGenerator.a(eC.a(projectDataManager.d(xmlName)), projectDataManager.h(xmlName));
                outputCode = xmlLayoutGenerator.b();
            }

            var ogFile = new File(layoutDir + xmlName);
            if (!layoutFiles.contains(ogFile)) {
                String finalName = isSimpleProject ? xmlName.replace(".xml", ".html") : xmlName;
                srcCodeBeans.add(new SrcCodeBean(finalName, CommandBlock.applyCommands(xmlName, outputCode)));

                if (isViewBindingEnable() && !isSimpleProject) {
                    var privFile = new File(context.getCacheDir(), xmlName);
                    FileUtil.writeFile(privFile.getAbsolutePath(), CommandBlock.applyCommands(xmlName, outputCode));
        ...
        for (ProjectFileBean customViewFile : customViewFiles) {
            ...
            if (isSimpleProject) {
                ProjectFileBean fileBean = null;
                for (ProjectFileBean bean : customViewFiles) {
                    if (xmlName.equalsIgnoreCase(bean.getXmlName())) {
                        fileBean = bean;
                        break;
                    }
                ...
                Ox xmlLayoutGenerator = new Ox(N, customViewFile);
                xmlLayoutGenerator.a(eC.a(projectDataManager.d(xmlName)));
                outputCode = xmlLayoutGenerator.b();
            }
        ...
        Ix manifestGenerator = new Ix(N, projectFileManager.b(), builtInLibraryManager);
        manifestGenerator.setProjectWorkspace(this);
        ...
        if (!isSimpleProject) {
            srcCodeBeans.add(new SrcCodeBean("AndroidManifest.xml", CommandBlock.applyCommands("AndroidManifest.xml", manifestGenerator.a())));
    ...
    public String getFileSrc(String filename, hC projectFileManager, eC projectDataManager, iC projectLibraryManager) {
        ...
        CommandBlock.x();
        boolean isJavaFile = filename.endsWith(".java") || filename.endsWith(".css");
        boolean isXmlFile = filename.endsWith(".xml") || filename.endsWith(".html");
        boolean isManifestFile = filename.equals("AndroidManifest.xml");

        if (isSimpleProject) {
            if (filename.endsWith(".html")) {
                // Find the actual ProjectFileBean to get the canonical Java Name
                ProjectFileBean fileBean = null;
                for (ProjectFileBean bean : projectFileManager.b()) {
                    if (filename.equalsIgnoreCase(bean.getXmlName())) {
                        fileBean = bean;
                        break;
                    }
                }
                
                String activityName = (fileBean != null) ? fileBean.getActivityName() : ProjectFileBean.getActivityName(filename.replace(".html", ""));
                ...
                // Ensure CSS also uses the canonical javaName for its logic blocks
                String baseName = filename.replace(".css", "");
                ProjectFileBean fileBean = null;
                for (ProjectFileBean bean : projectFileManager.b()) {
                    if (bean.getXmlName().equalsIgnoreCase(baseName + ".html")) {
                        fileBean = bean;
                        break;
                    }
                }
                ...
                if (cssBlocks.isEmpty()) {
                    // Fallback to internal storage if custom is empty (for migration/existing blocks)
        ...
        if (isManifestFile) {
            ...
            Ix manifestGenerator = new Ix(N, projectFileManager.b(), builder.getBuiltInLibraryManager());
            manifestGenerator.setProjectWorkspace(this);
            return CommandBlock.applyCommands("AndroidManifest.xml", manifestGenerator.a());
        }
    ...
    public void setProjectWorkspace(ProjectWorkspace workspace) {
        // This method was originally setProjectWorkspace(ProjectWorkspace) in some classes, 
        // we keep it for transition if needed, though this class is ProjectWorkspace.
    }
