package laki.webide.activities.main.activities;
...
import laki.webide.activities.main.fragments.projects.ProjectsFragment;
import laki.webide.activities.main.fragments.projects_store.ProjectsStoreFragment;
import laki.webide.databinding.MainBinding;
import laki.webide.utility.DataResetter;
    ...
    public void s() {
        if (storageAccessDenied == null || !storageAccessDenied.isShown()) {
            ...
            storageAccessDenied.setAction(Helper.getResString(R.string.common_word_settings), v -> {
                v.getContext().startActivity(new Intent(Settings.ACTION_APPLICATION_DETAILS_SETTINGS, Uri.parse("package:" + getPackageName())));
            });
