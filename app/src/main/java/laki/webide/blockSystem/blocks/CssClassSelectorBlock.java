...
public class CssClassSelectorBlock extends ModularBlockDefinition {
    @Override public String getOpCode() { return "cssClassSelector"; }
    @Override public String getSpec() { return ".%m.htmlClass {"; }
