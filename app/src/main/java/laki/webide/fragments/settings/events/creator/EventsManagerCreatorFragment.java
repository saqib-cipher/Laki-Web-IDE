package laki.webide.fragments.settings.events.creator;
...
import laki.webide.databinding.FragmentEventsManagerCreatorBinding;
...
public class EventsManagerCreatorFragment extends qA {
    ...
    private void save() {
        ...
        String concat = FileUtil.getExternalStorageDir().concat("/.lakiwebsites//data/system/events.json");
