...
import laki.webide.databinding.CodeEditorHsBinding;
...
public class SrcCodeEditor extends BaseAppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (fromAndroidManifest) {
            String filePath = FileUtil.getExternalStorageDir() + "/.lakiwebsites/data/" + scId + "/Injection/androidmanifest/activities_components.json";
