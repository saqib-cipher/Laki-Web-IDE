...
import static laki.webide.utility.SketchwareUtil.getDip;
...
import laki.webide.databinding.ActivityManageCustomAttributeBinding;
import laki.webide.databinding.CustomDialogAttributeBinding;
...
public class AndroidManifestInjectionDetails extends BaseAppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ATTRIBUTES_FILE_PATH = FileUtil.getExternalStorageDir().concat("/.lakiwebsites/data/").concat(src_id).concat("/Injection/androidmanifest/attributes.json");
        setupConst();
        setToolbar();
        setupViews();
    }
