...
import laki.webide.databinding.DialogCreateNewFileLayoutBinding;
import laki.webide.databinding.PreferenceActivityBinding;
...
public class ConfigActivity extends BaseAppCompatActivity {
    ...
    public static final File SETTINGS_FILE = new File(FileUtil.getExternalStorageDir(), ".lakiwebsites/data/settings.json");
    ...
    public static String getBackupPath() {
        return DataStore.getInstance().getString(SETTING_BACKUP_DIRECTORY, "/.lakiwebsites/backups/");
    }
        ...
        public void onCreatePreferences(@Nullable Bundle savedInstanceState, @Nullable String rootKey) {
            ...
            backupDir.setOnPreferenceClickListener(preference -> {
                ...
                AlertDialog dialog = new MaterialAlertDialogBuilder(requireContext())
                        ...
                        .setMessage("Directory inside /Internal storage/, e.g. .lakiwebsites/backups")
