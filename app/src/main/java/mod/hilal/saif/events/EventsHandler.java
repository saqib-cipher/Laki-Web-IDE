...
public class EventsHandler {
    ...
    public static final String CUSTOM_EVENTS_FILE_PATH = FileUtil.getExternalStorageDir() + "/.lakiwebsites/data/system/events.json";
    public static final String CUSTOM_LISTENERE_FILE_PATH = FileUtil.getExternalStorageDir() + "/.lakiwebsites/data/system/listeners.json";
     ...
     * /Internal storage/.lakiwebsites/data/system/events.json and specifying an empty string for "var"
     */
