...
import laki.webide.databinding.DialogSelectLibrariesBinding;
import laki.webide.databinding.ManageLibraryExcludeBuiltinLibrariesBinding;
...
public class ExcludeBuiltInLibrariesActivity extends BaseAppCompatActivity {
    ...
    private static File getConfigPath(String sc_id) {
        return new File(Environment.getExternalStorageDirectory(),
                ".lakiwebsites" + File.separator + "data" + File.separator + sc_id + File.separator + "excluded_library");
    }
